...
const Sell = () => {
  ...
  const handleInputChange = ({ target }) => {
    ...
    if (target.name === "brand") {
      setModels(getModelName(target.value));
    }
  };
    ...
    <div className="sell-container">
      <Card className="sell-card">
        ...
        <div
          ...
          style={{ width: "100%", position: "fixed", top: 5, zIndex: 333 }}
        >
          <Toast
            show={alertShow}
        ...
        <Form className="m-3 sell-form" onSubmit={submitHandler}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select aria-label="Default select example">
              <option>Select KM Driven</option>
              {kmDriven.map((element, index) => {
                return (
                  <option value={element} key={index}>
                    {element}
                  </option>
          ...
          <Form.Group className="mb-3">
            <Form.Label>Registered State</Form.Label>
            <Form.Select aria-label="Default select example">
          ...
          <Form.Group>
            <Form.Label>Thumbnail Photo</Form.Label>
            <Form.Control type="file" />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label htmlFor="seller name">Seller Name</Form.Label>
            <Form.Control
              type="text"
              id="seller name"
          ...
          <Form.Group className="mb-3">
            <Form.Label htmlFor="sellerNumber">Seller Number</Form.Label>
            <Form.Control
              type="number"
              id="sellerNumber"
              aria-describedby="passwordHelpBlock"
